...
public:
	 ...
	 *
	 * @param wait whether calling routine want to wait for result
	 ...
	 */
	virtual int command_exec(const bool wait, const string& command, vector<string>& result, bool& more);
	/**
